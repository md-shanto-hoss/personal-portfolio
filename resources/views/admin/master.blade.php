                ...
                <ul class="metismenu list-unstyled" id="side-menu">
                    ...
                    <li>
                        <a href="javascript: void(0);" class="has-arrow waves-effect">
                            ...
                            <span key="t-layouts">Personal Module</span>
                        </a>
                        <ul class="sub-menu" >
                            <li>
                            ...
                            <li>
                                <a href="{{route('personal.manage')}}" >Manage Personal</a>
                            </li>
                        </ul>
                    </li>
                    ...
                    <li>
                        <a href="javascript: void(0);" class="has-arrow waves-effect">
                            ...
                            <span key="t-dashboards">Service Module</span>
                        </a>
                        <ul class="sub-menu" aria-expanded="false">
                            <li><a href="{{route('service.add')}}" key="t-tui-calendar">Add Service</a></li>
                            <li><a href="{{route('service.manage')}}" key="t-full-calendar">Manage Service</a></li>
                        </ul>
                    </li>
                    ...
                    <li>
                        <a href="javascript: void(0);" class="has-arrow waves-effect">
                            ...
                            <span key="t-ecommerce">Education Module</span>
                        </a>
                        <ul class="sub-menu" aria-expanded="false">
                            <li><a href="{{route('education.add')}}" key="t-products">Add Education</a></li>
                            <li><a href="{{route('education.manage')}}" key="t-product-detail">Manage Education</a></li>
                        </ul>
                    </li>
                    ...
                    <li>
                        <a href="javascript: void(0);" class="has-arrow waves-effect">
                            ...
                            <span key="t-crypto">Experience Module</span>
                        </a>
                        <ul class="sub-menu" aria-expanded="false">
                            <li><a href="{{route('experience.add')}}" key="t-wallet">Add Experience</a></li>
                            <li><a href="{{route('experience.manage')}}" key="t-buy">Manage Experience</a></li>
                        </ul>
                    </li>
                    ...
                    <li>
                        <a href="javascript: void(0);" class="has-arrow waves-effect">
                            ...
                            <span key="t-email">Work Module</span>
                        </a>
                        <ul class="sub-menu" aria-expanded="false">
                            <li><a href="{{route('work.add')}}" key="t-inbox">Add Work</a></li>
                            <li><a href="{{route('work.manage')}}" key="t-read-email">Manage Work</a></li>
                        </ul>
                    </li>
