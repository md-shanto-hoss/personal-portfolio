            ...
            <div class="card-body">
                ...
                <form action="{{route('education.create')}}" method="POST">
                    ...
                    <div class="row mb-4">
                        ...
                        <div class="col-sm-9">
                            <input type="text" class="form-control" name="name" placeholder="degree name "/>
                        </div>
                    </div>
                    <div class="row mb-4">
                    ...
                    <div class="row mb-4">
                        ...
                        <div class="col-sm-9">
                            <textarea name="description" class="form-control" placeholder="Education Description" rows="5"></textarea>
                        </div>
                    </div>
